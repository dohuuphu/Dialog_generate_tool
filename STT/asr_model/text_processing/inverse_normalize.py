...
from asr_model.text_processing.normalize import Normalizer
from asr_model.text_processing.token_parser import TokenParser
...
class InverseNormalizer(Normalizer):
    ...
    def __init__(self, lang: str = 'en', cache_dir: str = None, overwrite_cache: bool = False):
        if lang == 'vi':
            from asr_model.text_processing.vi.taggers.tokenize_and_classify import ClassifyFst
            from asr_model.text_processing.vi.verbalizers.verbalize_final import (
                VerbalizeFinalFst,
            )
        else:
